...
public class PersonServiceTest
{
    ...
    {
        var personDbContext = new PersonsDbContext(new DbContextOptionsBuilder<PersonsDbContext>().Options);
        _countryService = new CountryService(personDbContext);
        _personService = new PersonService(personDbContext, _countryService);
    }
    #endregion
