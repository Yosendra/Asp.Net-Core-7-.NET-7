...
//    Order = 3)]
[ResponseHeaderActionFilter("Key-From-Controller", "Value-From-Controller", 3)]             // now we write it like this instead like above
...
public class PersonController : Controller
{
    ...
    //    Order = 1)]
    [ResponseHeaderActionFilter("Key-From-Action", "Value-From-Action", 1)]                     // now we write it like this instead like above
