...
public class PersonController : Controller
{
    ...
    [Route("[action]/{id}")]
    // [TypeFilter(typeof(TokenResultFilter))]                                     // comment out the TokenResultFilter filter to not give token cookie
    ...
    [TypeFilter(typeof(PersonAlwaysRunResultFilter))]                               // apply PersonAlwaysRunResultFilter filter
