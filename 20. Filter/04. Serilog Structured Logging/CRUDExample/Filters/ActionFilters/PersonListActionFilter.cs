...
public class PersonListActionFilter : IActionFilter
{
    ...
    public void OnActionExecuted(ActionExecutedContext context)
    {
        ...
        // Structured Logging
        _logger.LogInformation("{FilterName}.{MethodName} method", nameof(PersonListActionFilter), nameof(OnActionExecuted));     // notice this
    ...
    {
        _logger.LogInformation("{FilterName}.{MethodName} method", nameof(PersonListActionFilter), nameof(OnActionExecuting));     // notice this
