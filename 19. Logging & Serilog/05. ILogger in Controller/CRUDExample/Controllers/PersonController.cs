...
public class PersonController : Controller
{
    ...
    private readonly ILogger<PersonController> _logger;     // the generic type is the location where the logger being injected, in this case it is PersonController 
