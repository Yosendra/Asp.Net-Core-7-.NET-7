...
public class PersonService : IPersonService
{
    ...
    private readonly ILogger<PersonService> _logger;    // the generic type is the location where the logger being injected, in this case it is PersonService 
    ...
    public async Task<List<PersonResponse>> GetFilteredPersons(string searchBy, string? keyword)
    {
        ...
        List<Person> personList = searchBy switch
        {
            ...
            nameof(PersonResponse.DateOfBirth)
                => await _personRepository.GetFilteredPerson(p => p.DateOfBirth.Value.ToString("dd MMMM yyyy").Contains(keyword)),
