...
public class PersonService : IPersonService
{
    ...
    public bool DeletePerson(Guid? id)
    {
        ...
        // Get the matching person from data store based on id
        Person? person = _personDataStore.FirstOrDefault(p => p.Id == id);
        ...
        // Delete the matching person from data store
        _personDataStore.RemoveAll(p => p.Id == id);

        // Return boolean value indicating whether person was deleted or not
        return true;
    }
