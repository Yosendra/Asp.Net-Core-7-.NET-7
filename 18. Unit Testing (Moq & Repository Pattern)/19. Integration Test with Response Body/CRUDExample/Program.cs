 ...
 *   
 *   
 *   Now we interest to assert the body of HTTP response
 *   Unfortunately xUnit cannot test DOM elements, we need to install package Fizzler & Fizzler.Systems.HtmlAgilityPack in our Test project
 *   
 *   In PersonControllerIntegrationTest we will assert the response body
 *   
 *   Look at: PersonControllerIntegrationTest.cs at Index_ReturnView()
 */
