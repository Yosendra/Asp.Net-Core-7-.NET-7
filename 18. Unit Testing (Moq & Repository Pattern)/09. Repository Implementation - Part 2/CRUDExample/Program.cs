 ...
 *   
 * Implementing our Repository
 *   Repository only responsible to Data Access Logic. 
 *   The responsibility of validation and calculation belong to Business Logic (Service)
 * 
 *   Look at: Repository project, CountryRepository.cs, PersonRepository.cs
 *            At GetFilteredPerson(Expression<Func<Person, bool>> predicate) is interesting
 *            
 */
