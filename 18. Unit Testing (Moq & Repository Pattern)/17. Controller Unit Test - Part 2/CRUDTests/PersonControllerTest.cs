...
public class PersonControllerTest
{
    ...
    public async Task Create_IfModelError_ReturnCreateView()
    {
        ...
        PersonController personController = new(_personService, _countryService);
        personController.ModelState.AddModelError("Name", "Name cannot be blank");  // notice this, manually add error to model
        ...
        viewResult.ViewData.Model.Should().Be(requestModel);
    }
